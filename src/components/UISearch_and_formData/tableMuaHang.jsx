...
export const preferredColumnsByReport = {
  ...
  bang_ke_hoa_don_mua_hang_va_dich_vu: [
    ...
    { key: 'tien0', title: 'Tiền hàng', width: 120, render: (val) => val ? val.toLocaleString('vi-VN') : '-' },
    { key: 'thue', title: 'Tiền thuế', width: 120, render: (val) => val ? val.toLocaleString('vi-VN') : '-' },
    { key: 'ttt', title: 'Tổng tiền', width: 120, render: (val) => val ? val.toLocaleString('vi-VN') : '-' },
  ...
  bang_ke_phieu_xuat_tra_lai_nha_cung_cap: [
    ...
    { key: 'dien_giai', title: 'Diễn giải', width: 220 },
    { key: 'tong_tien_hang', title: 'Tổng tiền hàng', width: 140, render: (val) => val ? val.toLocaleString('vi-VN') : '-' },
  ...
  bang_ke_phieu_nhap_cua_mot_mat_hang: [
    ...
    { key: 'gia', title: 'Giá', width: 120, render: (val) => val ? val.toLocaleString('vi-VN') : '-' },
  ...
  bang_ke_phieu_nhap_cua_mot_mat_hang_nhom_theo_nha_cung_cap: [
    ...
    { key: 'so_luong', title: 'Số lượng', width: 100 },
    { key: 'gia', title: 'Giá', width: 120, render: (val) => val ? val.toLocaleString('vi-VN') : '-' },
    { key: 'tien', title: 'Tổng tiền', width: 120, render: (val) => val ? val.toLocaleString('vi-VN') : '-' },
    { key: 'ma_nx', title: 'Mã nx', width: 100 },
    { key: 'ma_kho', title: 'Mã kho', width: 100 },
  ...
  bao_cao_tong_hop_hang_nhap_mua: [
    ...
    { key: 'ten_vt', title: 'Tên vật tư', width: 200 },
    { key: 'dvt', title: 'Đvt', width: 80 },
    { key: 'so_luong', title: 'Số lượng', width: 100 },
    { key: 'gia', title: 'Giá', width: 120 },
    { key: 'tien', title: 'Tổng tiền', width: 120 },
    { key: 'nh_vt1', title: 'Nhóm vật tư 1', width: 120 },
    { key: 'nh_vt2', title: 'Nhóm vật tư 2', width: 120 },
    { key: 'nh_vt3', title: 'Nhóm vật tư 3', width: 120 }
  ],
  ...
  bang_ke_chung_tu: [
    ...
    { key: 'ten_tk', title: 'Tên tài khoản', width: 150 },
    { key: 'ten_tk_du', title: 'Tên tài khoản đối ứng', width: 180 },
    { key: 'ma_ct', title: 'Mã c.từ', width: 100 },
    { key: 'ma_dvcs', title: 'Mã ĐVCS', width: 100 },
    { key: 'ma_ku', title: 'Mã khế ước', width: 120 },
    { key: 'ma_td', title: 'Mã tự do 1', width: 120 },
    { key: 'ma_td2', title: 'Mã tự do 2', width: 120 },
    { key: 'ma_td3', title: 'Mã tự do 3', width: 120 },
    { key: 'ma_hd', title: 'Mã h.động bán', width: 130 },
    { key: 'ma_hdm', title: 'Mã h.động mua', width: 130 }
  ],
  ...
  bang_ke_chung_tu_theo_nha_cung_cap: [
    ...
    { key: 'ten_kh', title: 'Tên khách hàng', width: 180 },
    { key: 'dien_giai', title: 'Diễn giải', width: 200 },
    { key: 'tk', title: 'Tài khoản', width: 100 },
    { key: 'tk_du', title: 'TK đ.ứng', width: 100 },
    { key: 'ps_no', title: 'Ps nợ', width: 120 },
    { key: 'ps_co', title: 'Ps có', width: 120 },
    { key: 'stt_rec', title: 'Mã dự án', width: 120 },
    { key: 'ten_tk', title: 'Tên tài khoản', width: 180 },
    { key: 'ten_tk_du', title: 'Tên tài khoản đối ứng', width: 200 },
    { key: 'ma_ct', title: 'Mã c.từ', width: 100 }
  ],

  tong_hop_so_phat_sinh_theo_nha_cung_cap: [
    { key: 'stt', title: 'Stt', width: 60 },
    { key: 'ma', title: 'Mã khách', width: 100 },
    { key: 'ten', title: 'Tên khách hàng', width: 200 },
    { key: 'no_ck', title: 'Phát sinh nợ', width: 150 },
    { key: 'co_ck', title: 'Phát sinh có', width: 150 }
  ],
