...
export default function HdBanDvPage() {
    const {
        dataTable,
        columnsTable,
        columnsSubTable,
    ...
    return (
        <>
            ...
            />
            <div className="px-4">
                <PageMeta title="Danh sách hóa đơn bán dịch vụ" description="Danh sách hóa đơn bán dịch vụ" />
                <PageBreadcrumb pageTitle="Danh sách hóa đơn bán dịch vụ" />
                <div className="space-y-6">
                    ...
                    <ConfirmModal
                        isOpen={isOpenDelete}
                        title="Xác nhận xóa"
                        message={`Bạn có chắc chắn muốn xóa hóa đơn bán dịch vụ "${recordToDelete?.so_ct || recordToDelete?.stt_rec
                            }" không?`}
