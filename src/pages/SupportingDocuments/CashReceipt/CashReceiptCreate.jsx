...
export const ModalCreateCashReceipt = ({ isOpenCreate, closeModalCreate }) => {
  ...
  const { mutateAsync: saveCashReceipt, isPending } = useCreateCashReceipt();
  ...
  }, [formData, hachToanData, totals, saveCashReceipt, closeModalCreate, resetForm, navigate, validateForm]);
