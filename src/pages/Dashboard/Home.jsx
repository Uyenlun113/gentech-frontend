export default function Home() {
  return (
    <div className="w-full h-full relative">
      {/* Ảnh nền full screen */}
      <img src="images/logo/nen.jpg" alt="" className="absolute inset-0 w-full h-full object-cover" />
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <img src="images/logo/GenTech-logo.png" alt="Diamond Soft" className="w-[400px] object-cover" />
        </div>
        ...
        <div className="flex justify-end px-4">
          <div className="relative">
            ...
            <div className="relative text-sm text-right leading-relaxed space-y-1 max-w-xl p-6">
              ...
              <p className="font-semibold">Công ty TNHH Công Nghệ GenTech</p>
              <p className="">Địa chỉ: CT3 Nghĩa Đô - Hà Nội</p>
