            ...
            <div style="font-family: Arial, sans-serif; padding: 20px;">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #ddd; padding: 8px;">${record.so_ct_trim || record.so_ct || '-'}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #ddd; padding: 8px;">${formatCurrency(record.ps_no || record.ps_co)}</td>
                    </tr>
                </table>
            </div>
        `;
