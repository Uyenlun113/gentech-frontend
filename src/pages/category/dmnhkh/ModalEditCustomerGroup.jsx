...
import { useUpdateCustomerGroup } from "../../../hooks/useCustomerGroups";


export const ModalEditCustomerGroup = ({ isOpenEdit, closeModalEdit, onSaveEdit, selectedCustomerGroup }) => {
    ...
    useEffect(() => {
        if (selectedCustomerGroup) {
            setFormData({
                loai_nh: selectedCustomerGroup.loai_nh?.toString() || "",
                ma_nh: selectedCustomerGroup.ma_nh || "",
                ten_nh: selectedCustomerGroup.ten_nh?.trim() || "",
            });
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await updateCustomerGroupMutation.mutateAsync({
                ma_kh: selectedCustomerGroup.ma_nh,
                loai_nh: selectedCustomerGroup.loai_nh,
                data: {
            ...
            <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
                ...
                <form className="flex flex-col" onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
                        ...
                        <Button size="sm" type="submit" disabled={updateCustomerGroupMutation.isLoading}>
                            {updateCustomerGroupMutation.isLoading ? "Đang cập nhật..." : "Cập nhật"}
                        </Button>
                    </div>
                </form>
            </div>
