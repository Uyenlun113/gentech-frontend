...
export default function PhieuXuatDcListPage() {
    ...
    return (
        <>
            <ModalCreatePhieuXuatDc
                isOpenCreate={isOpenCreate}
                closeModalCreate={closeModalCreate}
            />
            <ModalEditPhieuXuatDc
            ...
            <div className="px-4">
                ...
                <div className="space-y-6">
                            ...
                            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                                ...
                                <form className="w-full sm:max-w-xs" onSubmit={handleSearchSubmit}>
                                    <div className="relative">
                                        ...
                                        <input
                                            type="text"
                                            placeholder="Tìm kiếm theo mã CT, mã kho..."
                    ...
                    <ConfirmModal
                        isOpen={isOpenDelete}
                        title="Xác nhận xóa"
                        message={`Bạn có chắc chắn muốn xóa phiếu xuất DC "${recordToDelete?.ma_ct || recordToDelete?.stt_rec
                            }" không?`}
