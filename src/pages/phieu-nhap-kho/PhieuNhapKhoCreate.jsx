...
import { useCreatePhieuNhapKho } from "../../hooks/usephieunhapkho";
...
export const ModalCreatePhieuNhapKho = ({ isOpenCreate, closeModalCreate }) => {
  ...
  const { mutateAsync: savePhieuNhapKho, isPending } = useCreatePhieuNhapKho();
  ...
  const handleSave = useCallback(async (e) => {
    ...
    try {
      ...
      await savePhieuNhapKho(payload);
      closeModalCreate();
      resetForm();
  ...
  }, [formData, hangHoaData, totals, savePhieuNhapKho, closeModalCreate, resetForm, navigate, validateForm]);
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Nhập thông tin Phiếu nhập kho mới vào hệ thống
              </p>
            </div>
          </div>
        </div>
