...
export default function NotFound() {
  return (
    <>
      ...
      />
      <div className="relative flex flex-col justify-center min-h-screen p-6 overflow-hidden z-1">
        <GridShape />
        <div className="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
          <img src="/images/error/phatrien.jpg" alt="404" className="dark:hidden" />
          <h1 className="mt-10 mb-6 text-2xl font-semibold text-green-700 dark:text-gray-400 ">
