...
export const ModalEditDepreciationCalculation = ({ isOpenEdit, closeModalEdit, onSaveEdit }) => {
  return (
    <Modal isOpen={isOpenEdit} onClose={closeModalEdit} className="max-w-[700px] m-4">
      <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
        <div className="px-2 pr-14">
          <h4 className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">Chỉnh sửa</h4>
