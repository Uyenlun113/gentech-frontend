...
import { useCreateGiayBaoNo } from "../../hooks/usegiaybaono";
...
export const ModalCreateGiayBaoNo = ({ isOpenCreate, closeModalCreate }) => {
  ...
  const { mutateAsync: saveGiayBaoNo, isPending } = useCreateGiayBaoNo();
  ...
  }, [formData, hachToanData, hopDongThueData, totals, saveGiayBaoNo, closeModalCreate, resetForm, navigate, validateForm]);
