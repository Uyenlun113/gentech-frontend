...
import PrintWrapperMuaHang from "../../components/PrintWrapperMuaHang.jsx";
import { ShowMoreTables } from "../../components/tables/ShowMoreTables/index.jsx";
import Button from "../../components/ui/button/Button.jsx";
import { useTablePrintMuaHang } from "./useTablePrintMuaHang.jsx";
import { getColumnsForReport } from "../../components/UISearch_and_formData/tableMuaHang.jsx";

export default function TablePrintMuaHang() {
    const location = useLocation();
    const navigate = useNavigate();
    const { columnsTable } = useTablePrintMuaHang();
    const printRef = useRef();

    const [dataTable, setDataTable] = useState([]);
    const [loading, setLoading] = useState(false);
    const [filterInfo, setFilterInfo] = useState(null);
    const [reportName, setReportName] = useState('Danh sách mua hàng');
    const [reportType, setReportType] = useState('mua_hang');
    ...
    useEffect(() => {
        if (location.state) {
            ...
            if (Array.isArray(rawData)) {
                ...
                const nextReportType = type || "mua_hang";
                setReportName(name || "Danh sách mua hàng");
