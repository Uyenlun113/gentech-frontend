...
const SoDuDauKyTable = () => {
  ...
  const getAccountName = (row) => row.account?.ten_tk || row.account?.name || `Tài khoản ${row.tk}`;
    ...
    <div className="px-4 bg-white dark:bg-gray-900 pt-2">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button onClick={handleShowModal} className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
            Tính tổng
          </button>
        </div>
      </div>
        ...
        <div className="overflow-x-auto max-h-[calc(100vh-280px)]">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            {cdtkData && cdtkData.length > 0 && (
              <tfoot
                className="sticky bottom-0 bg-white p-2 text-right font-semibold z-10 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30 
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-96 max-w-md mx-4">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Tính tổng</h3>
              <button
                ...
                .map((account) => (
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      />
                      <div>
                        <div className="text-sm font-medium text-gray-900 dark:text-white">{account.tk}</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">{account.ten_tk}</div>
                      </div>
                    </div>
                  </div>
                ))}
      ...
      {showDetailModal && selectedAccountDetail && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-100 max-w-lg mx-4">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Tổng số</h3>
              <button
            ...
            <div className="space-y-0">
              ...
              <div className="grid grid-cols-3 border-b border-gray-300 dark:border-gray-600 pb-2 mb-2">
                <div></div>
                <div className="text-center text-sm font-medium text-gray-700 dark:text-gray-300">Tiền VNĐ</div>
                <div className="text-center text-sm font-medium text-gray-700 dark:text-gray-300">Tiền n.tệ</div>
              </div>

              {/* Data rows */}
              <div className="grid grid-cols-3 py-2 border-b border-gray-200 dark:border-gray-600">
                <div className="text-sm text-gray-900 dark:text-white">Dư nợ ban đầu</div>
              ...
              <div className="grid grid-cols-3 py-2 border-b border-gray-200 dark:border-gray-600">
                <div className="text-sm text-gray-900 dark:text-white">Dư có ban đầu</div>
                <div className="text-center">
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-3 py-2 border-b border-gray-200 dark:border-gray-600">
                <div className="text-sm text-gray-900 dark:text-white">Dư nợ đầu năm tài chính</div>
                <div className="text-center">
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-3 py-2 border-b border-gray-200 dark:border-gray-600">
                <div className="text-sm text-gray-900 dark:text-white">Dư có đầu năm tài chính</div>
                <div className="text-center">
                  <input
                    type="text"
